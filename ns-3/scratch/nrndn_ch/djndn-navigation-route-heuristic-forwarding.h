...
#ifndef DJNDN_NAVIGATION_ROUTE_HEURISTIC_FORWARDING_H_
#define DJNDN_NAVIGATION_ROUTE_HEURISTIC_FORWARDING_H_
 ...
 */
class djNavigationRouteHeuristic: public GreenYellowRed
{
public:
	static TypeId
	GetTypeId(void);
	...
	djNavigationRouteHeuristic ();

	virtual ~djNavigationRouteHeuristic ();
